...
export default function App() {
  ...
  const createDefaultQuoteSession = (idNumber = 1, titleOverride = null) => ({
    ...
    aiItinerary: "",
    aiPitch: "",
    customQuoteText: undefined, // Allows overriding the auto-generated quote text
  });
  ...
  // Proposal Hub state
  const [activeTab, setActiveTab] = useState("quote"); // 'quote' | 'itinerary' | 'pitch'
  const [aiLoading, setAiLoading] = useState(false);

  // Current active quote helper
  const currentQuote = quotes[activeQuoteIndex] || quotes[0];

  // Quick quote update helper
  ...
  // Display text: either custom edited text or auto-generated text
...
2. "WHATSAPP_PITCH": Warm, high-converting sales pitch to send to customer on WhatsApp.`;
      ...
      // Offline Detailed Hourly Schedule Generator
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "20px 16px 120px" }}>
        ...
        {/* Costing calculation summary card */}
        <div style={{
          ...
          {/* Collapsible cost breakdown dropdown */}
        ...
        <div style={{ background: COLORS.oceanLight, borderRadius: 18, padding: 16, marginBottom: 18 }}>
          ...
          {/* Tab 1: Formatted WhatsApp Quotation Text (Now Fully Editable) */}
          {activeTab === "quote" && (
